...
export function HowItWorks() {
  ...
  return <section id="how-it-works" className="py-20 md:py-32 relative overflow-hidden">
      {/* Background */}
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="max-w-6xl mx-auto space-y-6 md:space-y-0 md:grid md:grid-cols-2 md:gap-6 lg:gap-8">
          {steps.map((step, index) => <div key={index} className={`relative group`} style={{
          animationDelay: `${index * 0.1}s`
              ...
              <div className={`card-glow p-6 md:p-8 h-full bg-gradient-to-br ${step.color} ${step.borderColor} border transition-all duration-500 hover:scale-[1.02] hover:shadow-xl`}>
                ...
                {index < steps.length - 1 && index % 2 === 0 && <div className="hidden md:flex absolute top-1/2 -right-4 lg:-right-6 z-20 -translate-y-1/2">
                ...
                <div className="flex flex-col h-full pt-4">
                  ...
                  <div className="mt-auto pt-4 border-t border-border/30">
                    <div className="flex flex-wrap gap-2">
                      {step.details.map((detail, i) => <div key={i} className="flex items-center gap-1.5 text-xs bg-background/50 px-3 py-1.5 rounded-full">
