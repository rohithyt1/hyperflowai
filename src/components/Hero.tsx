...
export function Hero() {
  ...
  return <section ref={containerRef} className="relative min-h-[90vh] flex items-center overflow-hidden pt-20 pb-12">
      {/* Animated gradient background */}
      <div className="absolute inset-0 bg-gradient-to-br from-background via-background to-card/50" />
      
      {/* Interactive cursor glow */}
      <div className="absolute inset-0 opacity-50 hidden md:block transition-all duration-500 pointer-events-none" style={{
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute w-[400px] h-[400px] bg-gradient-to-br from-primary/20 to-transparent rounded-full blur-[80px]" style={{
        top: '10%',
        left: '5%',
        transform: `translate(${mousePosition.x * 30}px, ${mousePosition.y * 30}px)`,
        transition: 'transform 0.8s ease-out'
      }} />
        <div className="absolute w-[300px] h-[300px] bg-gradient-to-br from-accent/15 to-transparent rounded-full blur-[60px]" style={{
        bottom: '20%',
        right: '10%',
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold leading-[1.1] mb-6 animate-fade-in" style={{
            animationDelay: '0.1s'
          }}>
            ...
            <p className="text-xl sm:text-2xl text-muted-foreground max-w-xl mx-auto lg:mx-0 mb-4 animate-fade-in" style={{
            animationDelay: '0.2s'
          }}>
            ...
            {/* Emoji flow */}
            <div className="flex items-center justify-center lg:justify-start gap-2 text-2xl mb-8 animate-fade-in" style={{
            ...
            animationDelay: '0.3s'
              ...
              <Button className="btn-hero group text-lg py-6 px-8" onClick={() => document.getElementById('pricing')?.scrollIntoView({
              behavior: 'smooth'
            })}>
            ...
            {/* Quick stats */}
            <div className="flex items-center justify-center lg:justify-start gap-8 text-sm text-muted-foreground animate-fade-in" style={{
          ...
          animationDelay: '0.4s'
            ...
            <div className="absolute -bottom-4 -left-4 z-20 bg-card border border-border/50 rounded-xl p-3 shadow-lg animate-float" style={{
            animationDelay: '0.5s'
          }}>
              <div className="flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto mt-16 animate-fade-in" style={{
        animationDelay: '0.5s'
      }}>
          {/* Without */}
